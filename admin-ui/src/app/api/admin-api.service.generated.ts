...
@Injectable()
export class AdminApiAuthsApiClient {
...
@Injectable()
export class AdminApiPostCategoriesApiClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
@Injectable()
export class AdminApiPostsApiClient {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    createPost(body?: UpsertPostRequest | undefined): Observable<void> {
     ...
     * @return Success
     */
    updatePost(id: string, body?: UpsertPostRequest | undefined): Observable<void> {
...
export class UpsertPostRequest implements IUpsertPostRequest {
    name?: string | undefined;
    slug?: string | undefined;
    description?: string | undefined;
    thumbnail?: string | undefined;
    ...
    constructor(data?: IUpsertPostRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpsertPostRequest {
        data = typeof data === 'object' ? data : {};
        let result = new UpsertPostRequest();
        result.init(data);
        return result;
    }
