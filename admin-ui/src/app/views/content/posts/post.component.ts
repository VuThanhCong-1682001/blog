...
import { AdminApiPostsApiClient, AdminApiPostCategoriesApiClient, PostCategoryDto, PostDto, PostInListDto, PostInListDtoPagedResult } from 'src/app/api/admin-api.service.generated';
import { PostSeriesComponent } from 'src/app/views/content/posts/post-series/post-series.component';
import { PostReturnReasonComponent } from 'src/app/views/content/posts/post-return-reason/post-return-reason.component';
import { PostActivityLogsComponent } from 'src/app/views/content/posts/post-activity-logs/post-activity-logs.component';
...
export class PostComponent implements OnInit, OnDestroy {
  ...
  constructor(
    private postCategoryApiClient: AdminApiPostCategoriesApiClient,
    private postApiClient: AdminApiPostsApiClient,
